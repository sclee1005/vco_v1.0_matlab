/*=================================================================
% perform_front_propagation_2d_addpd - perform a Fast Marching front propagation.
%
%   [D,S,Q,PD] = perform_front_propagation_2d_addpd(W,start_points,end_points,nb_iter_max, H, L, values);
%
...
void perform_front_propagation_2d_addpd(T_callback_intert_node callback_insert_node)
{
