...
/////////////////////////////////////
#ifndef _PERFORM_FRONT_PROPAGATION_2D_INTENSITY_H_
#define _PERFORM_FRONT_PROPAGATION_2D_INTENSITY_H_
...
// main function
void perform_front_propagation_2d_intensity(T_callback_intert_node callback_insert_node = NULL);

#endif // _PERFORM_FRONT_PROPAGATION_2D_INTENSITY_H_